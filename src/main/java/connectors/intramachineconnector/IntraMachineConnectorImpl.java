...
import connectors.intramachineconnector.base.IntraMachineConnectorBase;
...
public class IntraMachineConnectorImpl extends IntraMachineConnectorBase {
    ...
    @Inject
    public IntraMachineConnectorImpl(@Named("HandshakeConnector") ActorRef handshakeconnector, OpcUaWrapper wrapper){
