...
import components.clienthandshakesouthactor.base.ClientHandshakeSouthActorBase;
...
public class ClientHandshakeSouthActorImpl extends ClientHandshakeSouthActorBase {
    ...
    @Inject
    public ClientHandshakeSouthActorImpl(@Named("NoConnector") ActorRef connectorTopDomain,
        ...
        this.capabilityId = TurntableModuleWellknownCapabilityIdentifiers.TRANSPORT_MODULE_SOUTH_CLIENT;
