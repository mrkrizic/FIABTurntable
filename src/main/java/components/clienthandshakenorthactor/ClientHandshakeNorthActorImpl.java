...
import components.clienthandshakenorthactor.base.ClientHandshakeNorthActorBase;
...
public class ClientHandshakeNorthActorImpl extends ClientHandshakeNorthActorBase {
    ...
    @Inject
    public ClientHandshakeNorthActorImpl(@Named("NoConnector") ActorRef connectorTopDomain,
